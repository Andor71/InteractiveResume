...
const overLay = document.querySelector(".overlayElements");
...
//Player Sprite , centered to the center
...
const bonFire = new Bonfire({
    ...
    imageSrc :["./img/character/kidle.png",
               "./img/character/kidleb.png"
                ],
...
function animate(){
    ...
    for(let i = 0 ; i < signs.length ; i++){
        if(bonFire.position.x >= signs[i].position.x -100 && bonFire.position.x < signs[i].position.x +40){
